...
class ReportStatusController extends Controller
{
    ...
    public function store(StoreReportStatusRequest $request)
    {
        ...
        Swal::toast("Status Laporan berhasil ditambahkan!", "success")->timerProgressBar();
    ...
    public function update(UpdateReportStatusRequest $request, string $id)
    {
        ...
        Swal::toast("Status laporan berhasil diubah!", "success")->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast("Status laporan berhasil dihapus!", "success")->timerProgressBar();

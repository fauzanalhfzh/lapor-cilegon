...
class ReportCategoryController extends Controller
{
    ...
    public function store(StoreReportCategoryRequest $request)
    {
        ...
        Swal::toast("Kategori laporan berhasil ditambahkan!", "success")->timerProgressBar();
    ...
    public function update(UpdateReportCategoryRequest $request, string $id)
    {
        ...
        Swal::toast("Kategori laporan berhasil diubah!", "success")->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast("Kategori laporan berhasil dihapus!", "success")->timerProgressBar();
